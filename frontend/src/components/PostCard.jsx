...
// //   return (
// //     <div className="article-card bg-white rounded-xl shadow-md overflow-hidden">
// //       <div className="h-48 overflow-hidden">
// //         <img 
// //           src={post.featuredImage || 'https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80'} 
// //           alt={post.title}
...
// //         <h3 className="text-xl font-bold text-dark mb-3 hover:text-primary transition">
...
//   // Function to handle image source with proper error handling
// //   const getImageSrc = () => {
...
// //     // If it's a relative path (starts with /uploads/ or /)
// //     if (post.featuredImage.startsWith('/')) {
// //       // Add your server URL to make it absolute
// //       return `http://localhost:5000${post.featuredImage}`;
// //     }
...
// // In your PostCard component, replace the getImageSrc function with this:
// const getImageSrc = () => {
...
//     console.log('🌐 Using relative path converted to:', fullUrl);
//     return fullUrl;
//   }
...
//   // Debug: log the image URL to see what we're working with
//   console.log('Post Card Image Debug:', {
//     title: post.title,
//     featuredImage: post.featuredImage,
//     finalSrc: getImageSrc(),
//     isBase64: post.featuredImage?.startsWith('data:image/'),
//     isRelative: post.featuredImage?.startsWith('/'),
//     isURL: post.featuredImage?.startsWith('http')
//   });
